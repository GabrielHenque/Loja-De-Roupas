...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  try {
    ...
    $sql = "SELECT * FROM usuarios WHERE email = :email AND senha = SHA2(:senha, 256) AND ativo = 1;";
    ...
    if ($dados != null) {
      ...
      $_SESSION['imagem_perfil'] = $dados[0]['img'];

      if ($dados[0]['id_nivel'] == 1) {

        header("location: principal.php");
      } else if ($dados[0]['id_nivel'] == 2) {
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
  ...
  <main class="form-signin w-100 m-auto">
    <form>
      ...
      <button class="btn btn-primary w-100 py-2 btn-entrar" type="submit">Entrar</button>
      <div>
        <a href="cadastrar.php" class="recuperar">Cadastrar</a>
      </div>
