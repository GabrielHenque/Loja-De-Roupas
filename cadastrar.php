...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="cadastrar.php" method="post">
            ...
            <div class="form-floating">
                <input type="password" class="form-control" id="senhacon" name="senhacon" placeholder="Confirmar Senha"
                    required>
                <label for="senhacon">Confirmar Senha</label>
            </div>

            <button class="btn btn-primary w-100 py-2 btn-entrar" type="submit">Cadastrar</button>
            <div>
                <a href="login.php" class="recuperar">Entrar</a>
            </div>
